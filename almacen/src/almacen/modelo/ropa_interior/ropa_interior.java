...
package almacen.modelo.ropa_interior;

/**
 *
 * @author ubuntu
 */
public class ropa_interior {
    private String codigo;
    private String color;
    private String talla;
    private String tipo_interior;
    private int item;
...
private String descripcion;
    ...
    /**
     * @return the tipo_interior
     */
    public String getTipo_interior() {
        return tipo_interior;
    }

    /**
     * @param tipo_interior the tipo_interior to set
     */
    public void setTipo_interior(String tipo_interior) {
